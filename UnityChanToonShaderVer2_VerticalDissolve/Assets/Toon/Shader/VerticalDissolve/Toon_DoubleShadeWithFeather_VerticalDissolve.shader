...
Shader "UnityChanToonShader/VerticalDissolve/Toon_DoubleShadeWithFeather" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        Pass {
            ...
            //アウトライン処理はUTS_Outline_VerticalDissolve.cgincへ.
            #include "UCTS_Outline_VerticalDissolve.cginc"
            ENDCG
        }
//ToonCoreStart
        Pass {
            ...
            #include "UCTS_DoubleShadeWithFeather_VerticalDissolve.cginc"
        ...
        Pass {
            ...
            //v.2.0.4
            #pragma multi_compile _IS_CLIPPING_OFF
            #include "UCTS_ShadowCaster_VerticalDissolve.cginc"
            ENDCG
        }
//ToonCoreEnd
    }

...
Shader "UnityChanToonShader/VerticalDissolve/NoOutline/ToonColor_DoubleShadeWithFeather" {
    Properties {
...
//
//v.2.0.4 Emissive
        _Emissive_Tex_And_Border_Tex ("Emissive_Tex & Border_Tex", 2DArray) = "white" {}
        [HDR]_Emissive_Color ("Emissive_Color", Color) = (0,0,0,1)
//VerticalDissolve
        _FillAmount("Fill Amount", Float) = 0.5
	[Toggle] _InvertMask("Invert", Float) = 0
	[Toggle] _Is_WorldCoordinates("Is World Coordinates", Float) = 0
	_BorderWidth("Border Width", Float) = 0.6
	[HDR] _BorderColor("Border Color", Color) = (1, 1, 1, 1)
	_NoiseScale("Noise Scale", Range(0, 20)) = 4
	_NoiseSpeed("Noise Speed", Vector) = (0.2, -0.6, 0.2, 0)
	[Toggle] _LayerNoise("Layer Noise", Float) = 0
	_Wave1_Amplitude("[Wave1] Amplitude", Range(0, 1)) = 0.2
	_Wave1_Frequency("[Wave1] Frequency", Range(0, 50)) = 0
	_Wave1_Offset("[Wave1] Offset", Float) = 0
	_Wave2_Amplitude("[Wave2] Amplitude", Range(0, 1)) = 0.2
	_Wave2_Frequency("[Wave2] Frequency", Range(0, 50)) = 0
	_Wave2_Offset("[Wave2] Offset", Float) = 0
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/VerticalDissolve/Toon_DoubleShadeWithFeather/FORWARD"
        UsePass "UnityChanToonShader/VerticalDissolve/Toon_DoubleShadeWithFeather/FORWARD_DELTA"
        UsePass "UnityChanToonShader/VerticalDissolve/Toon_DoubleShadeWithFeather/SHADOWCASTER"
    }
